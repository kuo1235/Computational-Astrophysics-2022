...
program angry_bird
    ...
    open(unit=11, file="angry_euler.dat")
    write(11,100) "# ", "time", "posx", "posy", "velx", "vely", "anal_y", "err_y", "Newerr_y"


    print *, "# time,  posx,  posy,  velx,  vely, anal_y, err_y, Newerr_y"
    print *, time, posx, posy, velx, vely, anal_y, 0.0, 0.0
   
    write(11,200) time, posx, posy, velx, vely, anal_y, 0.0, 0.0
    ...
    do while (posy .ge. 0.0)
        ...
        print *, time, posx, posy, velx, vely,anal_y,abs((anal_y-posy))/anal_y, (abs((anal_y-posy))/8.0)

        write(11,200) time, posx, posy, velx, vely, anal_y, abs((anal_y-posy))/anal_y, (abs((anal_y-posy))/8.0)  

    end do

100 format(a2, 2a24, 2a24, 2a24, 2a24, 2a24, 2a24, 2a24, 2a24)
200 format(2x, 2F24.14, 2F24.14, 2F24.14, 2F24.14, 2F24.14, 2F24.14, 2F24.14, 2F24.14)
    close(11)
